...
- Distance: Camera moves to medium distance (8-10 feet)
- Focus: Your body approaching door, hand reaching handle
- Detail: Determined hand motion on door handle
- Action: Door handle pull begins (smooth, confident)
- Lighting: Teal-lit practical lights on car surface
- Framing: You in profile, car door about to open

**4-6 SEC: DOOR OPENS & SITS DOWN**
- Movement: Camera follows smooth action (door opening)
- Distance: Medium shot (6-8 feet from car)
- Action: Door opens fully, interior light spills out
- Pivot: You pivot smoothly and sit into driver's seat
- Motion: One fluid sitting motion (no hesitation)
- Lighting: Interior light now visible, teal-graded
- Detail: Hands visible on door frame during sit

**6-8 SEC: INTERIOR REVEAL & SETTLING**
- Movement: Camera follows into interior (smooth push in)
- Distance: Tighter shot (3-4 feet from you)
- Framing: You settling into driver's seat
- Action: Hands grip steering wheel with focused intensity
- Focus: Upper body visible, concentrated expression
- Lighting: Interior practical lighting with teal grade
- Detail: Steering wheel, hands, focused face visible

**8-10 SEC: FINAL HERO MOMENT**
- Movement: Final camera push (slight push in or slight pull)
- Distance: Close-up medium shot (2-3 feet)
- Framing: You at steering wheel, hands positioned, focused expression
- Action: Engine off (final moment of settling, ready for action)
- Lighting: Full interior illuminated, teal-blue grade saturates
- Mood: Hero moment locked - confident, focused, ready
- Final Frame: You at wheel, teal-lit interior, professional intensity
...
**Camera Movement:**
- Type: Smooth tracking dolly (no jitters, professional)
- Speed: Continuous smooth motion (~1-2 feet per second)
- Path: Straight line approach then follow into car interior
- Rig: Professional steadicam or motorized dolly system

**Lens & Focus:**
- Focal Length: 35mm to 50mm equivalent (cinematic)
- Aperture: T2.8 to T4.0 (shallow to medium depth)
- Focus Method: Follow focus or continuous autofocus (smooth)
- Depth of Field: Selective focus on you, background soft
...
**Composition:**
- Framing: Professional cinema framing (rule of thirds, leading lines)
- Depth: Layered (foreground car, you, background environment)
- Perspective: Hero POV (camera follows your action, you are star)
- Symmetry: Balanced professional composition

**Camera Movement Quality:**
- Smoothness: Zero jitter, professional steadicam quality
- Motivation: Every move motivated by your action
- Timing: Precision timing with door opening and sitting
- Continuity: Seamless transition from exterior to interior
...
**Expression & Energy:**
- Eyes: Focused, intense, determined (hero presence)
- Face: Neutral to slight confidence (cool, composed)
- Jaw: Set, composed (focused determination)
- Overall: Professional confidence, controlled power

**Movement & Action:**
- Approach: Determined, purposeful stride (confident walk)
- Door Handle: Smooth, confident grip (no hesitation)
- Sitting: One fluid motion (athletic, practiced)
- Steering Wheel: Hands settle with focused intent
- Speed: All movements confident and controlled

**Emotional Arc:**
- 0-2s: Hero introduction (establishing presence)
- 2-4s: Determined action (approaching, committing to motion)
- 4-6s: Fluid execution (smooth sitting, athletic)
- 6-10s: Settled focus (hands at wheel, ready for action)

**Performance Quality:**
- Authenticity: Genuine confident movement
- Timing: Precise, professional execution
- Presence: Clear hero protagonist energy
- Confidence: Undeniable composed power
...
**Music/Underscore:**
- Optional: Cinematic underscore (minimal, supporting)
- Style: Tense, focused, hero moment energy
- Tempo: Slow to moderate (matching camera speed)
- Presence: Minimal if present, supporting not dominating

**Sound Mix Priority:**
1. Footsteps (confident approach)
2. Door handle/opening (mechanical precision)
3. Seating sounds (settling in place)
4. Ambient night sounds (urban environment)
5. Optional music (very minimal underscore)
...
**Camera Equipment:**
- Steadicam or motorized dolly (professional smooth motion)
- Follow focus system (precise focus pulling)
- Cinema lenses (35-50mm range, T2.8-4.0)
...
**COMPARABLE FILMS/MOMENTS:**
- Drive opening (teal-graded cool confidence)
- Blade Runner 2049 (stylized hero cinematography)
- James Bond car introductions (hero moment, sleek vehicle)
- Nightcrawler opening (urban night, professional intensity)
